...
function WSWITCH:DrawBarBg(x, y, w, h, col)
  ...
  -- surface.DrawRect( rx, ry+b, b, rh-b*2 )
	surface.DrawRect( rx+b - 8, ry, h + 4, rh )
   draw.RoundedBox(0, rx+b + 15, ry, 1, rh, Color(0,0,0) )
   -- Draw the remainder
...
function WSWITCH:DrawWeapon(x, y, c, wep)
   ...
   -- Slot
   local spec = {text=wep.Slot+1, font="FontO28", pos={x + 1, y}, yalign=TEXT_ALIGN_CENTER, color=c.text}
